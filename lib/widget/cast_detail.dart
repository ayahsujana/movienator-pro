...
import 'package:the_movienator_pro/widget/cast_image.dart';
                    ...
                    child: new ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        return Container(
                          ...
                          child: new SimilarMovies(casting['combined_credits']['cast'][index],casting['combined_credits']['cast'][index]['media_type']),
                        );
                      },
                    ),
                  )
